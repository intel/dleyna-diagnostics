...
#include <libdleyna/diagnostics/control-point-diagnostics.h>

#define DLD_DIAGNOSTICS_SERVICE_NAME "dleyna-diagnostics-service"
...
int main(int argc, char *argv[])
{
	...
	retval = dleyna_main_loop_start(DLD_DIAGNOSTICS_SERVICE_NAME,
					dleyna_control_point_get(),
					NULL);
